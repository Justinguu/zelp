      ...
      <div className="login-container">
        <div className="login-wrapper">
          ...
          <form className="login-form" onSubmit={onLogin}>
            <div className="login-font">Log in to zelp</div>
            <div className="new-to-zelp">
              New to Zelp?
              <NavLink className="signup-redirect" to="/sign-up">
                Sign up
              </NavLink>
            </div>
            <div className="login-errors">
              {onceSubmitted && errors.map((error, ind) => <div key={ind}>{error}</div>)}
            </div>
