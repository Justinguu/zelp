...
def seed_users():
    ...
    bobbie = User(
        first_name="Bob", last_name="lition", username="boblition", email="bob@aa.io", password="password", profileImage="https://wallpapers.com/images/hd/deadpool-logo-cool-profile-picture-g2sv7i8j6nzd7tfa-g2sv7i8j6nzd7tfa.jpg")
    sam = User(
